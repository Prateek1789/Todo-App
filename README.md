...
- Priority based auto sorting and completed task based auto sorting.          
- Progress bar with Total and Completed task count.     
- Clean and Responsive UI                

Note: being a Frontend project, this app currently uses Browsers local storage to store data.   